...
public class Contract {
    ...
    public static final String[] colorsStr = new String[]{
            "#ff512da7", "#ff00786b", "#ff455a64", "#ff0096a6"
    };
    public static final String[] colorsLighterStr = new String[]{
            "#ff663ab6", "#ff009587", "#ff607c8a", "#ff4ebcc7"
    };


    public static int[] colors = new int[]{0xff512da7, 0xff00786b, 0xff455a64, 0xff0096a6};
    public static int[] colorsLighter = new int[]{0xff663ab6, 0xff009587, 0xff607c8a, 0xff4ebcc7};
